...
const RiderStatus = () => {
  return (
    <div>
      <div className='bg-[#111] border-[1px] border-black  mt-7 mb-3 text-white flex flex-col gap-7 items-start justify-between p-35'>
            <div className=''>
            ...
            <div className='flex items-center justify-between gap-10 text-2xl px-12'>
              ...
              <h4 className='text-[#E24B95] font-bold'><i class="ri-phone-line"></i>Contact Driver</h4>
            </div>
      </div>
    </div>
  )
